...
export function Sidebar({
    ...
    return (
        <aside
            className={`fixed top-0 left-0 z-40 h-full w-64 bg-background text-foreground border-r border-border dark:border-primary-foreground p-4 space-y-4 overflow-y-auto transform transition-transform duration-300 ease-in-out
